...
function Warn_No_URL_Provided(channel)
  channel:add_system_message(SYSTEM_MSG_PREFIX .. "No URL provided!")
end

---@param channel c2.Channel
---@param url string
function Warn_URL_Not_YouTube(channel, url)
  channel:add_system_message(SYSTEM_MSG_PREFIX ..
...
function Warn_Faulty_URL(channel, url)
  channel:add_system_message(SYSTEM_MSG_PREFIX .. "Faulty URL: " .. url)
end
...
function Warn_Status_Not_200_URL(channel, url, code)
  channel:add_system_message(SYSTEM_MSG_PREFIX .. "URL: " .. url .. " returned status code: " .. code)
end

---@param channel c2.Channel
---@param url string
function Warn_No_VideoId(channel, url)
  channel:add_system_message(SYSTEM_MSG_PREFIX .. "Couldn't find videoId while parsing HTML in URL: " .. url)
end
...
function Log_Reading_URL(channel, url)
  channel:add_system_message(SYSTEM_MSG_PREFIX .. "Reading URL: " .. url)
end
